...
#import "kazurabashi.h"

@interface kazurabashi ()

@end

@implementation kazurabashi{
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    str = @"https://api.instagram.com/v1/tags/かずら橋/media/recent?access_token=1317256297.4391fe2.f80770052f314ee790ef15658d0a2c3e&count=100";
    ...
    self.kazurabashiImageView.contentMode = UIViewContentModeScaleAspectFit;
...
-(void)showRamenImage{
    ...
    self.kazurabashiImageView.image = image;
